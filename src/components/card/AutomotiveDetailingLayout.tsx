          ...
          <motion.div custom={4} initial="hidden" animate="visible" variants={fadeUp} className="px-5 pt-6 pb-2">
            ...
            >
              ...
              <div className="flex items-center gap-2.5 mb-4 relative z-10">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.3em]" style={{ color: bioTexto ? bioTexto + 'aa' : 'rgba(255,255,255,0.3)' }}>Sobre o Estúdio</span>
              </div>
