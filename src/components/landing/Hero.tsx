      ...
      <div className="container relative z-10 px-6 py-20">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            >
              Seu cartão de visitas <br className="hidden sm:block" />
              <span className="gradient-text">profissional</span> em um único link
            </motion.h1>
            ...
            >
              A forma mais simples de autônomos e freelancers passarem confiança, facilitarem o contato pelo WhatsApp e fecharem mais negócios. 
              <strong> Sem gastar com impressões.</strong>
            </motion.p>
          </div>
          ...
          >
            ...
            <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground/60">
              Grátis para sempre • Comece agora
            </p>
          </motion.div>
        </div>
      </div>
