  ...
  return (
    <div className="bg-[#030712] text-slate-155 font-sans min-h-screen selection:bg-[#dfba83]/30 selection:text-white relative overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-36 flex flex-col justify-center items-center overflow-hidden border-b border-white/5">
        {/* Glow Effects */}
        <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[900px] h-[350px] rounded-full bg-blue-500/10 blur-[130px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PRODUTOS.map((product, idx) => {
            ...
            return (
              <div 
                key={product.id}
                className="bg-[#090D16]/90 border border-white/5 hover:border-white/10 rounded-[2.2rem] p-8 flex flex-col justify-between transition-all duration-300 hover:y-[-6px] relative group"
              >
                <div>
                  {/* Card Header & Icon */}
      ...
      <section id="demonstracoes" className="py-24 max-w-7xl mx-auto px-6 border-b border-white/5 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {DEMONSTRACOES.map((demo, idx) => (
            <div 
              key={idx}
              className="bg-[#090D16]/90 border border-white/5 rounded-[2rem] overflow-hidden group cursor-pointer"
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 border-b border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="bg-[#090D16]/50 border border-white/5 p-8 rounded-[2rem] relative flex flex-col justify-between">
              <div>
        ...
        <div className="space-y-4">
          {FAQS.map((faq, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-[#090D16]/60 border border-white/5 rounded-2xl overflow-hidden transition-all"
              >
                <button
